...
class ImovelController extends Controller
    ...
    public function salvar(Request $request)
    {
       ...
       $file = $request->file('imagem');
        ...
        \Session::flash('mensagem',['msg'=>'Imovel cadastrado com sucesso!', 'class'=>'green white-text']);
     ...
     public function editar($id)
    {
     ...
     public function atualizar(Request $request, $id)
        ...
        \Session::flash('mensagem',['msg'=>'Imovel alterado com sucesso!', 'class'=>'green white-text']);
        return redirect()->route('admin.imoveis');		        
...

    {
        ...
        \Session::flash('mensagem',['msg'=>'Imovel excluido com sucesso!', 'class'=>'green white-text']);
        return redirect()->route('admin.imoveis');
    }
}