...
class HomeController extends Controller
{
    public function index()
    {
    	...
    	$imoveis = Imovel::where('publicar','=','sim')->orderBy('id', 'desc')->paginate(4);
  ...
  public function busca(Request $request)
    {
        ...
        $numDorm = $busca['dormitorios'];
         ...
         $testeValor = [
            ...
            [['valor', '>=', 1000],['valor','<=',50000]],
            [['valor', '>=', 50000],['valor','<=',100000]],
            [['valor', '>=', 100000],['valor','<=',2000000]],
            [['valor', '>=', 2000000],['valor','<=',3000000]],
            [['valor', '>=', 3000000],['valor','<=',5000000]],
            [['valor', '>=', 5000000],['valor','<=',10000000]],
            [['valor', '>=', 500]]
        ];
