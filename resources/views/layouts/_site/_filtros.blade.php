<div class="row"> 
	<form action="{{route('site.busca')}}" >
		...
		<select name="status">
			<option {{isset($busca['status']) && $busca['status'] == 'todos' ? 'selected' : ''}} value="todos">Vende e aluga</option>
		...
		<select name="dormitorios">
			...
			<option {{isset($busca['dormitorios']) && $busca['dormitorios'] == 3 ? 'selected' : ''}} value="3">3 ou mais</option>
		</select>
		...
		<button class="btn depp-orange darken1 right">Filtrar</button>
		</div>
	</form>
</div>