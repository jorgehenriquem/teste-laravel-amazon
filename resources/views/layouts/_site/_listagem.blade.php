<div class="row section">
	<h3 align="center">Listagem Medica</h3>
		...
		<div class="col s12 m3" >
			<div class="card" >
				<div class="card-image" >				
					...
					<p>R${{ number_format($imovel->valor)}}</p>
				</div>
				<div class="card-action"><a href="{{route('site.imovel',[$imovel->id,str_slug($imovel->titulo,'_')])}}">Ver mais</a>
				</div>
				</div>
			</div>
